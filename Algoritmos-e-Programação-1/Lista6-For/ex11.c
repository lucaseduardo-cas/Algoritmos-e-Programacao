/*
Desafio
Individualmente ou em duplas vocês irâo tentar resolver o seguinte problema:
...
- Se serão digitadas datas válidas e a primeira sempre será anterior a segunda;
